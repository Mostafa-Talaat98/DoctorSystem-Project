...
if (accountSid && accountSid.startsWith('AC') && authToken) {
  ...
  console.warn('Twilio credentials missing or invalid. SMS functionality will be disabled.');
}
...
export async function sendVerifyPhoneOtp({ phoneNumber }) {
  ...
  if (!client) {
    ...
    throw new Error('SMS service is currently unavailable. Please use email verification.');
  }
